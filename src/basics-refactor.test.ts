...
// */
 ...
 describe("Problema de propietats opcionals", () => {
   const getName = (params: { first: string; last?: string }) => {     // ? para que el valor de las variables sean opcional
     if (params.last) {
...
// */
 ...
 describe("Problema d'intersecció de tipus", () => {
   ...
   const getDefaultUserAndPosts = (): User & {posts: Post[]}  => {  // combina ambos tipos
     return {
       id: "1",
       firstName: "Jen",
       lastName: "Simmons",
...
// */
  ...
  describe("Problema de tipus de funció amb promeses", () => {
     ...
     interface User {
       ...
       const createThenGetUser = async (   // Tipado de funciones async como parametros 
